...
ATROCITY_TAXONOMY = {
    "IMMEDIATE_PHYSICAL_VIOLENCE": {
        ...
        "keywords": [
            ...
            "hang", "maarna", "jaan se maar", "goli maar", "kat dunga"
        ],
    },
    ...
    "SOCIAL_BOYCOTT_AND_BLOCKADE": {
        ...
        "keywords": [
            ...
            "hukka pani band", "paani nahi lene de rahe", "bahishkar"
        ],
    },
    "CASTE_SLURS_AND_HUMILIATION": {
        ...
        "keywords": [
            ...
            "अछूत", "जूता चटवाया", "मुंह काला", "casteist abuse", "caste slur",
            "untouchable", "forced to crawl", "neech jati", "chamar", "bhangi", "achhoot"
        ],
    },
    "DISPLACEMENT_AND_PROPERTY_DAMAGE": {
        ...
        "keywords": [
            ...
            "ghar tod diya", "zameen cheen li", "ghar jala diya"
        ],
    },
    "INTIMIDATION_AND_THREAT": {
        ...
        "keywords": [
            ...
            "dhamki", "case wapas le", "police me mat jao"
        ],
    },
    "SEVERE_PSYCHOLOGICAL_DISTRESS": {
        ...
        "keywords": [
            ...
            "darr lag raha", "kaamp rahe", "madad karo", "bachao"
        ],
    },
}
...
def analyze_transcript_semantics(
    ...
    caste atrocity, physical violence, social boycott, and trauma indicators.
    """
    ...
    # Calculate overall linguistic threat score (0.0 - 1.0)
    base_score = max_weight
    # Additional penalty for multiple co-occurring indicators
    co_occurrence_boost = min(0.25, len(detected_categories) * 0.08)
